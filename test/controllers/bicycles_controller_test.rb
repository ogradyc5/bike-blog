...
class BicyclesControllerTest < ActionController::TestCase
  ...
  test "should create bicycle" do
    assert_difference('Bicycle.count') do
      post :create, bicycle: { description: @bicycle.description, price: @bicycle.price, title: @bicycle.title }
    end
  ...
  test "should update bicycle" do
    patch :update, id: @bicycle, bicycle: { description: @bicycle.description, price: @bicycle.price, title: @bicycle.title }
    assert_redirected_to bicycle_path(assigns(:bicycle))
  end
